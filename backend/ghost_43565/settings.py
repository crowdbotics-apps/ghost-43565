"""
Django settings for ghost_43565 project.
...
WSGI_APPLICATION = 'ghost_43565.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ghost_43565 API",
    "DESCRIPTION": "API documentation for ghost_43565 App",
    "VERSION": "v1",
}
